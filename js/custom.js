...
(function($){
  "use strict";
	...
	var tar;
	var timing = 500;
	$('div.prt_menu_wrapper a, .prt_about_wrapper a.hire_me').on('click' , function(e){
		e.preventDefault();
	...
	$(".submitForm").on("click", function() {
		...
		if(check == 0){
			...
			$.ajax({
				method : 'post',
				url : 'https://script.google.com/macros/s/AKfycbzd2ordblRCjhc0kBnaD3eODlq1IsIrgeHgTwnUutb3nXLXYT1ikOyhP60NRCEArV1R/exec',
				data:formDetail,
				cache:false,
				contentType: false,
				processData: false,
